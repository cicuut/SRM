...
class User(db.Model):
    ...
    # Untuk fitur update foto di Account Setting.
    # Isi bisa berupa data URL base64 dari frontend atau URL gambar.
...
class Financial(db.Model):
    ...
    # Nullable supaya invoice unpaid bisa disimpan tanpa metode pembayaran.
