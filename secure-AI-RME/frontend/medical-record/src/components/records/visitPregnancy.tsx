...
const VisitPregnancyAccordition = () => {
    ...
    const [visitPregnancy, setvisitPregnancy] = useState<VisitPregnancyAccorditionList[]>([]);
    ...
    return (
        <div className="w-full">
            {visitPregnancy.map((visitPregnancy) => (
                <Accordion key={visitPregnancy.visit_id} disableGutters
                    elevation={2}
                    sx={{
                         margin: "1.5em 0px", 
                    ...
                    <AccordionSummary
                        ...
                        <div className="flex items-center gap-4">
                            <p className="font-bold text-[#4F6F52] text-[15px]">{visitPregnancy.visit_date}</p>
                        </div>
                    </AccordionSummary>
