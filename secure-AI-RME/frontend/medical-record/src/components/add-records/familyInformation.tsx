    ...
    return (
        <>
            <div className="flex flex-col gap-0">
                <h2 className="text-md text-[#4F6F52]  underline leading-none !font-lexend">Identitas Keluarga</h2>
                <hr className="mt-0"></hr>
            </div>
            <div className="grid grid-cols-1 gap-4 px-3 pb-5 md:grid-cols-2">

                <label className="block">
                    <p className="text-md font-medium text-gray-700 md:text-sm"> Nama Lengkap <span className="text-red-500">*</span></p>
                ...
                <label className="block">
                    <p className="text-md font-medium text-gray-700 md:text-sm">NIK<span className="text-red-500">*</span></p>
                ...
                <div className="grid grid-cols-2 gap-4 md:col-span-2 md:grid-cols-4">
                    <label className="block">
                        <p className="text-md font-medium text-gray-700 md:text-sm">Tanggal Lahir<span className="text-red-500">*</span></p>
                    ...
                    <label className="block">
                        <p className="text-md font-medium text-gray-700 md:text-sm">Jenis Kelamin<span className="text-red-500">*</span></p>
                    ...
                    <label className="block">
                        <p className="text-md font-medium text-gray-700 md:text-sm">Hubungan<span className="text-red-500">*</span></p>
                ...
                <label className="block">
                    <p className="text-md font-medium text-gray-700 md:text-sm">No. Telepon<span className="text-red-500">*</span></p>
                ...
                <label className="block">
                    <p className="text-md font-medium text-gray-700 md:text-sm">Alamat<span className="text-red-500">*</span></p>
                ...
                <label className="block">
                    <p className="text-md font-medium text-gray-700 md:text-sm">Pendidikan</p>
                ...
                <label className="block">
                    <p className="text-md font-medium text-gray-700 md:text-sm">Pekerjaan</p>
