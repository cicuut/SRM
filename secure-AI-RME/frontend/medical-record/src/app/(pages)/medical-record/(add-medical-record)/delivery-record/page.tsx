            ...
            <div className="flex-1 flex flex-col w-full ml-10 mt-7">
                ...
                <div className="flex flex-col mt-4 gap-y-4">
                    <div className="flex flex-row w-full gap-20 justify-between">
                        ...
                        <div className="flex flex-col  flex-1">
                            Berat Badan
                            <input type="text" name="birthWeight" value={birthWeight} onChange={(e) => setBirthWeight(e.target.value)} id="birthWeight" className="w-full h-8 rounded-md bg-white drop-shadow-lg border border-gray-300 focus:outline-none focus:ring-2 p-2" />
                        </div>
                        <div className="flex flex-col  flex-1">
                            Panjang Badan
                            <input type="text" name="birthLenght" value={birthLenght} onChange={(e) => setBirthLenght(e.target.value)} id="birthLenght" className="w-full h-8 rounded-md bg-white drop-shadow-lg border border-gray-300 focus:outline-none focus:ring-2 p-2" />
                        </div>
                    </div>
