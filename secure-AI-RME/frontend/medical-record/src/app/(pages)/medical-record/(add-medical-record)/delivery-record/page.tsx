...
const DeliveryRecord = () => {
    ...
    return (
        <div className="relative flex w-full min-w-0 flex-col gap-4">
            ...
            <div className="grid grid-cols-1 gap-4 px-5 pb-5">
                <div className="grid grid-cols-1 gap-4  md:grid-cols-2">
                    <label className="block">
                        <p className="text-md font-medium text-gray-700 md:text-sm">Tanggal Persalinan</p>
                    ...
                    <label className="block">
                        <p className="text-md font-medium text-gray-700 md:text-sm">Metode Persalinan</p>
                ...
                <label className="block">
                    <p className="text-md font-medium text-gray-700 md:text-sm">Komplikasi Persalinan</p>
            ...
            <div className="flex flex-col gap-0">
                <h2 className="text-md text-[#4F6F52] underline leading-none">Riwayat Bayi Baru Lahir</h2>
                <hr className="mt-0"></hr>
            </div>
            <div className="grid grid-cols-1 gap-4 px-5  md:grid-cols-4">
                ...
                <label className="block">                          Panjang Badan
                ...
                <label className="block">                    APGAR Score
            ...
            <div className="grid grid-cols-1 gap-4 px-5 pb-5">                <div className="flex flex-col flex-1" >
                Komplikasi
